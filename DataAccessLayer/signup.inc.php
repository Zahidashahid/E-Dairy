...
<?php
	...
	{
		function getInstanceOfDatabaseConnection()
		{
			$objDatabaseConnection = new DatabaseConnection;
			return $objDatabaseConnection;
		}
		
		function getInstanceOfQueryProcessor()
		{
			$objQueryProcessor = new QueryProcessor;
			return $objQueryProcessor;
		}
	}
	...
	class QueryProcessor()
	{
		...
		{
			$objDatabaseConnection = $objDatabaseController->getInstanceOfDatabaseConnection();
